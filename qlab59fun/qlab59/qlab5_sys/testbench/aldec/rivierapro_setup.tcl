...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "E:/cad/altera/13.0sp1/quartus/"
} 
...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/qlab5_sys_irq_mapper.sv"             -work irq_mapper                                                            
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/altera_merlin_arbitrator.sv"         -work rsp_xbar_mux_001                                                      
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/qlab5_sys_rsp_xbar_mux_001.sv"       -work rsp_xbar_mux_001                                                      
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/altera_merlin_arbitrator.sv"         -work cmd_xbar_mux                                                          
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/qlab5_sys_cmd_xbar_mux.sv"           -work cmd_xbar_mux                                                          
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/qlab5_sys_cmd_xbar_demux_001.sv"     -work cmd_xbar_demux_001                                                    
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/qlab5_sys_cmd_xbar_demux.sv"         -work cmd_xbar_demux                                                        
  ...
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/qlab5_sys_id_router_001.sv"          -work id_router_001                                                         
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/qlab5_sys_id_router.sv"              -work id_router                                                             
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/qlab5_sys_addr_router_001.sv"        -work addr_router_001                                                       
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/qlab5_sys_addr_router.sv"            -work addr_router                                                           
  ...
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/altera_merlin_slave_agent.sv"        -work onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv" -work onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/altera_merlin_master_agent.sv"       -work cpu_0_instruction_master_translator_avalon_universal_master_0_agent   
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/altera_merlin_slave_translator.sv"   -work onchip_memory2_0_s1_translator                                        
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/altera_merlin_master_translator.sv"  -work cpu_0_instruction_master_translator                                   
  ...
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/verbosity_pkg.sv"                    -work qlab5_sys_inst_clk_0_clk_in_reset_bfm                                 
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/altera_avalon_reset_source.sv"       -work qlab5_sys_inst_clk_0_clk_in_reset_bfm                                 
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/verbosity_pkg.sv"                    -work qlab5_sys_inst_clk_0_clk_in_bfm                                       
  vlog  "$QSYS_SIMDIR/qlab5_sys_tb/simulation/submodules/altera_avalon_clock_source.sv"       -work qlab5_sys_inst_clk_0_clk_in_bfm                                       
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L rsp_xbar_mux_001 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L id_router_001 -L id_router -L addr_router_001 -L addr_router -L onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent -L cpu_0_instruction_master_translator_avalon_universal_master_0_agent -L onchip_memory2_0_s1_translator -L cpu_0_instruction_master_translator -L cpu_0 -L pio_0 -L onchip_memory2_0 -L qlab5_sys_inst_clk_0_clk_in_reset_bfm -L qlab5_sys_inst_clk_0_clk_in_bfm -L qlab5_sys_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
