...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/flab5_irq_mapper.sv"                 -work irq_mapper                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/flab5_rsp_xbar_demux.sv"             -work rsp_xbar_demux                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"         -work cmd_xbar_mux                                                          
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/flab5_cmd_xbar_mux.sv"               -work cmd_xbar_mux                                                          
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/flab5_cmd_xbar_demux.sv"             -work cmd_xbar_demux                                                        
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/flab5_id_router.sv"                  -work id_router                                                             
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/flab5_addr_router.sv"                -work addr_router                                                           
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/flab5_pio_0.v"                       -work pio_0                                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/flab5_nios2_qsys_0.v"                -work nios2_qsys_0                                                          
  vlogan +v2k           "$QSYS_SIMDIR/submodules/flab5_nios2_qsys_0_test_bench.v"     -work nios2_qsys_0                                                          
  vlogan +v2k           "$QSYS_SIMDIR/submodules/flab5_onchip_memory2_0.v"            -work onchip_memory2_0                                                      
  vlogan +v2k           "$QSYS_SIMDIR/flab5.v"                                                                                                                    
fi
