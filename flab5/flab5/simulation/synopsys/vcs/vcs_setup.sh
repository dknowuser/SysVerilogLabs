...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/flab5_irq_mapper.sv \
  $QSYS_SIMDIR/submodules/flab5_rsp_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv \
  $QSYS_SIMDIR/submodules/flab5_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/flab5_cmd_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/flab5_id_router.sv \
  $QSYS_SIMDIR/submodules/flab5_addr_router.sv \
  ...
  $QSYS_SIMDIR/submodules/flab5_pio_0.v \
  $QSYS_SIMDIR/submodules/flab5_nios2_qsys_0.v \
  $QSYS_SIMDIR/submodules/flab5_nios2_qsys_0_test_bench.v \
  $QSYS_SIMDIR/submodules/flab5_onchip_memory2_0.v \
  $QSYS_SIMDIR/flab5.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
