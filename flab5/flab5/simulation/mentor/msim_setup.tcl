...
# ACDS 12.1sp1 243 win32 2020.03.08.21:25:20
...
file copy -force $QSYS_SIMDIR/submodules/flab5_nios2_qsys_0_rf_ram_a.dat ./
file copy -force $QSYS_SIMDIR/submodules/flab5_nios2_qsys_0_rf_ram_a.hex ./
file copy -force $QSYS_SIMDIR/submodules/flab5_nios2_qsys_0_rf_ram_a.mif ./
file copy -force $QSYS_SIMDIR/submodules/flab5_nios2_qsys_0_rf_ram_b.dat ./
file copy -force $QSYS_SIMDIR/submodules/flab5_nios2_qsys_0_rf_ram_b.hex ./
file copy -force $QSYS_SIMDIR/submodules/flab5_nios2_qsys_0_rf_ram_b.mif ./
file copy -force $QSYS_SIMDIR/submodules/flab5_onchip_memory2_0.hex ./
...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/flab5_irq_mapper.sv"                 -work irq_mapper                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/flab5_rsp_xbar_demux.sv"             -work rsp_xbar_demux                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"         -work cmd_xbar_mux                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/flab5_cmd_xbar_mux.sv"               -work cmd_xbar_mux                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/flab5_cmd_xbar_demux.sv"             -work cmd_xbar_demux                                                        
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/flab5_id_router.sv"                  -work id_router                                                             
  vlog -sv "$QSYS_SIMDIR/submodules/flab5_addr_router.sv"                -work addr_router                                                           
  ...
  vlog     "$QSYS_SIMDIR/submodules/flab5_pio_0.v"                       -work pio_0                                                                 
  vlog     "$QSYS_SIMDIR/submodules/flab5_nios2_qsys_0.v"                -work nios2_qsys_0                                                          
  vlog     "$QSYS_SIMDIR/submodules/flab5_nios2_qsys_0_test_bench.v"     -work nios2_qsys_0                                                          
  vlog     "$QSYS_SIMDIR/submodules/flab5_onchip_memory2_0.v"            -work onchip_memory2_0                                                      
  vlog     "$QSYS_SIMDIR/flab5.v"                                                                                                                    
}
