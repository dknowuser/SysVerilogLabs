...
# ACDS 12.1sp1 243 win32 2020.02.29.18:48:43
...
file copy -force $QSYS_SIMDIR/submodules/qlab5_onchip_memory2_0.hex ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_nios2_qsys_0_rf_ram_a.dat ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_nios2_qsys_0_rf_ram_a.hex ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_nios2_qsys_0_rf_ram_a.mif ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_nios2_qsys_0_rf_ram_b.dat ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_nios2_qsys_0_rf_ram_b.hex ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_nios2_qsys_0_rf_ram_b.mif ./
...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_irq_mapper.sv"                 -work irq_mapper                                                                
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_cmd_xbar_demux.sv"             -work cmd_xbar_demux                                                            
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_id_router.sv"                  -work id_router                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_addr_router.sv"                -work addr_router                                                               
  ...
  vlog     "$QSYS_SIMDIR/submodules/qlab5_pio_0.v"                       -work pio_0                                                                     
  vlog     "$QSYS_SIMDIR/submodules/qlab5_onchip_memory2_0.v"            -work onchip_memory2_0                                                          
  vlog     "$QSYS_SIMDIR/submodules/qlab5_nios2_qsys_0.v"                -work nios2_qsys_0                                                              
  vlog     "$QSYS_SIMDIR/submodules/qlab5_nios2_qsys_0_test_bench.v"     -work nios2_qsys_0                                                              
  vlog     "$QSYS_SIMDIR/qlab5.v"                                                                                                                        
}
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L irq_mapper -L cmd_xbar_demux -L rst_controller -L id_router -L addr_router -L onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L onchip_memory2_0_s1_translator -L nios2_qsys_0_instruction_master_translator -L pio_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L irq_mapper -L cmd_xbar_demux -L rst_controller -L id_router -L addr_router -L onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L onchip_memory2_0_s1_translator -L nios2_qsys_0_instruction_master_translator -L pio_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
