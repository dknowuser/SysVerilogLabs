...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_irq_mapper.sv"                 -work irq_mapper                                                                 -cdslib ./cds_libs/irq_mapper.cds.lib                                                                
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_cmd_xbar_demux.sv"             -work cmd_xbar_demux                                                             -cdslib ./cds_libs/cmd_xbar_demux.cds.lib                                                            
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_id_router.sv"                  -work id_router                                                                  -cdslib ./cds_libs/id_router.cds.lib                                                                 
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_addr_router.sv"                -work addr_router                                                                -cdslib ./cds_libs/addr_router.cds.lib                                                               
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/qlab5_pio_0.v"                       -work pio_0                                                                      -cdslib ./cds_libs/pio_0.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/qlab5_onchip_memory2_0.v"            -work onchip_memory2_0                                                           -cdslib ./cds_libs/onchip_memory2_0.cds.lib                                                          
  ncvlog     "$QSYS_SIMDIR/submodules/qlab5_nios2_qsys_0.v"                -work nios2_qsys_0                                                               -cdslib ./cds_libs/nios2_qsys_0.cds.lib                                                              
  ncvlog     "$QSYS_SIMDIR/submodules/qlab5_nios2_qsys_0_test_bench.v"     -work nios2_qsys_0                                                               -cdslib ./cds_libs/nios2_qsys_0.cds.lib                                                              
  ncvlog     "$QSYS_SIMDIR/qlab5.v"                                                                                                                                                                                                                              
fi
