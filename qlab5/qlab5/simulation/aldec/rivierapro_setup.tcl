...
# ACDS 12.1sp1 243 win32 2020.02.29.18:48:45
...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/submodules/qlab5_irq_mapper.sv"                 -work irq_mapper                                                                
  vlog  "$QSYS_SIMDIR/submodules/qlab5_cmd_xbar_demux.sv"             -work cmd_xbar_demux                                                            
  ...
  vlog  "$QSYS_SIMDIR/submodules/qlab5_id_router.sv"                  -work id_router                                                                 
  vlog  "$QSYS_SIMDIR/submodules/qlab5_addr_router.sv"                -work addr_router                                                               
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L cmd_xbar_demux -L rst_controller -L id_router -L addr_router -L onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L onchip_memory2_0_s1_translator -L nios2_qsys_0_instruction_master_translator -L pio_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
