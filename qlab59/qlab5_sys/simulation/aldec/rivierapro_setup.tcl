...
# ACDS 12.1sp1 243 win32 2020.03.08.17:33:25
...
file copy -force $QSYS_SIMDIR/submodules/qlab5_sys_cpu_0_rf_ram_a.dat ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_sys_cpu_0_rf_ram_a.hex ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_sys_cpu_0_rf_ram_a.mif ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_sys_cpu_0_rf_ram_b.dat ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_sys_cpu_0_rf_ram_b.hex ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_sys_cpu_0_rf_ram_b.mif ./
file copy -force $QSYS_SIMDIR/submodules/qlab5_sys_onchip_memory2_0.hex ./
...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_irq_mapper.sv"             -work irq_mapper                                                            
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"         -work rsp_xbar_mux_001                                                      
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_rsp_xbar_mux_001.sv"       -work rsp_xbar_mux_001                                                      
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"         -work cmd_xbar_mux                                                          
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_mux.sv"           -work cmd_xbar_mux                                                          
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_demux_001.sv"     -work cmd_xbar_demux_001                                                    
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_demux.sv"         -work cmd_xbar_demux                                                        
  ...
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_id_router_001.sv"          -work id_router_001                                                         
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_id_router.sv"              -work id_router                                                             
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_addr_router_001.sv"        -work addr_router_001                                                       
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_addr_router.sv"            -work addr_router                                                           
  vlog  "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"             -work onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent_rsp_fifo
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"        -work onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv" -work onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"       -work cpu_0_instruction_master_translator_avalon_universal_master_0_agent   
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"   -work onchip_memory2_0_s1_translator                                        
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"  -work cpu_0_instruction_master_translator                                   
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_cpu_0.v"                   -work cpu_0                                                                 
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_cpu_0_test_bench.v"        -work cpu_0                                                                 
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_pio_0.v"                   -work pio_0                                                                 
  vlog  "$QSYS_SIMDIR/submodules/qlab5_sys_onchip_memory2_0.v"        -work onchip_memory2_0                                                      
  vlog  "$QSYS_SIMDIR/qlab5_sys.v"                                                                                                                
}
