...
# ACDS 12.1sp1 243 win32 2020.03.08.17:33:23
...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_irq_mapper.sv"             -work irq_mapper                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"         -work rsp_xbar_mux_001                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_rsp_xbar_mux_001.sv"       -work rsp_xbar_mux_001                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"         -work cmd_xbar_mux                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_mux.sv"           -work cmd_xbar_mux                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_demux_001.sv"     -work cmd_xbar_demux_001                                                    
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_demux.sv"         -work cmd_xbar_demux                                                        
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_id_router_001.sv"          -work id_router_001                                                         
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_id_router.sv"              -work id_router                                                             
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_addr_router_001.sv"        -work addr_router_001                                                       
  vlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_addr_router.sv"            -work addr_router                                                           
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"        -work onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv" -work onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"       -work cpu_0_instruction_master_translator_avalon_universal_master_0_agent   
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"   -work onchip_memory2_0_s1_translator                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"  -work cpu_0_instruction_master_translator                                   
