...
# ACDS 12.1sp1 243 win32 2020.03.08.17:33:24
...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/qlab5_sys_irq_mapper.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv \
  $QSYS_SIMDIR/submodules/qlab5_sys_rsp_xbar_mux_001.sv \
  $QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_demux_001.sv \
  $QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/qlab5_sys_id_router_001.sv \
  $QSYS_SIMDIR/submodules/qlab5_sys_id_router.sv \
  $QSYS_SIMDIR/submodules/qlab5_sys_addr_router_001.sv \
  $QSYS_SIMDIR/submodules/qlab5_sys_addr_router.sv \
  ...
  $QSYS_SIMDIR/submodules/qlab5_sys_cpu_0.v \
  $QSYS_SIMDIR/submodules/qlab5_sys_cpu_0_test_bench.v \
  $QSYS_SIMDIR/submodules/qlab5_sys_pio_0.v \
  $QSYS_SIMDIR/submodules/qlab5_sys_onchip_memory2_0.v \
  $QSYS_SIMDIR/qlab5_sys.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
