...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  ...
  cp -f $QSYS_SIMDIR/submodules/qlab5_sys_onchip_memory2_0.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_irq_mapper.sv"             -work irq_mapper                                                             -cdslib ./cds_libs/irq_mapper.cds.lib                                                            
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_rsp_xbar_mux_001.sv"       -work rsp_xbar_mux_001                                                       -cdslib ./cds_libs/rsp_xbar_mux_001.cds.lib                                                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"         -work cmd_xbar_mux                                                           -cdslib ./cds_libs/cmd_xbar_mux.cds.lib                                                          
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_mux.sv"           -work cmd_xbar_mux                                                           -cdslib ./cds_libs/cmd_xbar_mux.cds.lib                                                          
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_demux_001.sv"     -work cmd_xbar_demux_001                                                     -cdslib ./cds_libs/cmd_xbar_demux_001.cds.lib                                                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_cmd_xbar_demux.sv"         -work cmd_xbar_demux                                                         -cdslib ./cds_libs/cmd_xbar_demux.cds.lib                                                        
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_id_router_001.sv"          -work id_router_001                                                          -cdslib ./cds_libs/id_router_001.cds.lib                                                         
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_id_router.sv"              -work id_router                                                              -cdslib ./cds_libs/id_router.cds.lib                                                             
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_addr_router_001.sv"        -work addr_router_001                                                        -cdslib ./cds_libs/addr_router_001.cds.lib                                                       
  ncvlog -sv "$QSYS_SIMDIR/submodules/qlab5_sys_addr_router.sv"            -work addr_router                                                            -cdslib ./cds_libs/addr_router.cds.lib                                                           
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"       -work cpu_0_instruction_master_translator_avalon_universal_master_0_agent    -cdslib ./cds_libs/cpu_0_instruction_master_translator_avalon_universal_master_0_agent.cds.lib   
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"  -work cpu_0_instruction_master_translator                                    -cdslib ./cds_libs/cpu_0_instruction_master_translator.cds.lib                                   
  ncvlog     "$QSYS_SIMDIR/submodules/qlab5_sys_cpu_0.v"                   -work cpu_0                                                                  -cdslib ./cds_libs/cpu_0.cds.lib                                                                 
  ncvlog     "$QSYS_SIMDIR/submodules/qlab5_sys_cpu_0_test_bench.v"        -work cpu_0                                                                  -cdslib ./cds_libs/cpu_0.cds.lib                                                                 
  ncvlog     "$QSYS_SIMDIR/submodules/qlab5_sys_pio_0.v"                   -work pio_0                                                                  -cdslib ./cds_libs/pio_0.cds.lib                                                                 
  ncvlog     "$QSYS_SIMDIR/submodules/qlab5_sys_onchip_memory2_0.v"        -work onchip_memory2_0                                                       -cdslib ./cds_libs/onchip_memory2_0.cds.lib                                                      
  ncvlog     "$QSYS_SIMDIR/qlab5_sys.v"                                                                                                                                                                                                                  
fi
